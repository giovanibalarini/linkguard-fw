...
func (fakeNetProvider) GenerateConfigs(netsvc.Config, []netsvc.Reservation, []string) []netsvc.ConfigFile {
	return nil
}
func (fakeNetProvider) Apply(context.Context, netsvc.Config, []netsvc.Reservation, []string) (string, error) {
	return "", nil
}
func (fakeNetProvider) ReloadConfigs(context.Context, netsvc.Config, []netsvc.Reservation, []string) (string, error) {
	return "", nil
}
