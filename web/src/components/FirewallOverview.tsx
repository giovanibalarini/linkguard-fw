...
// A ordem dentro da forward (linhas de bloqueio e jumps de grupo) não é mais
// fixa: ela é a ordem da lista da aba "Grupos de regras", e esta tela mostra
// as linhas exatamente na sequência em que o nft as devolve.
